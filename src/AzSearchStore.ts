...
export class AzSearchStore {
  ...
  public setSearchParameters(searchParameters: Store.SearchParameters) {
    this.store.dispatch(
      searchParameterActions.setSearchParameters(searchParameters),
    );
  }
  public updateSearchParameters(
    searchParametersUpdate: Store.SearchParametersUpdate,
  ) {
    this.store.dispatch(
      searchParameterActions.updateSearchParameters(searchParametersUpdate),
    );
  }
  ...
  public setSuggestionsApiVersion(apiVersion: Store.SearchApiVersion) {
    this.store.dispatch(
      suggestionsParameterActions.setSuggestionsApiVersion(apiVersion),
    );
  }
  public setSuggestionsParameters(
    suggestionsParameters: Store.SuggestionsParameters,
  ) {
    this.store.dispatch(
      suggestionsParameterActions.setSuggestionsParameters(
        suggestionsParameters,
      ),
    );
  }
  public updateSuggestionsParameters(
    suggestionsParametersUpdate: Store.SuggestionsParametersUpdate,
  ) {
    this.store.dispatch(
      suggestionsParameterActions.updateSuggestionsParameters(
        suggestionsParametersUpdate,
      ),
    );
  }
  ...
  public addRangeFacet(
    ...
    this.store.dispatch(
      facetsActions.addRangeFacet(fieldName, dataType, min, max),
    );
  }
  ...
  public toggleCheckboxFacet(fieldName: string, value: string | number) {
    this.store.dispatch(
      facetsActions.toggleCheckboxFacetSelection(fieldName, value),
    );
  }
  public setFacetRange(
    fieldName: string,
    lowerBound: number,
    upperBound: number,
  ) {
    this.store.dispatch(
      facetsActions.setFacetRange(fieldName, lowerBound, upperBound),
    );
  }
  ...
  public setSuggestionsProcessor(
