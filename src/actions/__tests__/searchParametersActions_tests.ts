...
describe('actions/searchParameters', () => {
  ...
  it('should create action to set all search parameters', () => {
    expect(
      searchParametersActions.setSearchParameters(
  ...
  it('should create action to update search parameters', () => {
    expect(
      searchParametersActions.updateSearchParameters(
        searchParameters.initialState,
      ),
    ).toEqual({
  ...
  it('should create action to incrememt skip', () => {
    expect(searchParametersActions.incrementSkip()).toEqual({
      type: 'INCREMENT_SKIP',
    });
  });
  it('should create action to decrement skip', () => {
    expect(searchParametersActions.decrementSkip()).toEqual({
      type: 'DECREMENT_SKIP',
    });
  });
  it('should create action to set page number', () => {
    expect(searchParametersActions.setPage(5)).toEqual({
      type: 'SET_PAGE',
      page: 5,
    });
  });
