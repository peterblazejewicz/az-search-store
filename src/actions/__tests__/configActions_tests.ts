...
describe('actions/config', () => {
  it('should create an action to set config', () => {
    expect(configActions.setConfig(config)).toEqual({
      type: 'SET_CONFIG',
      config,
    });
  });
  it('should create an action to set searchCallback', () => {
    expect(configActions.setSearchCallback(searchCallback)).toEqual({
      type: 'SET_SEARCH_CALLBACK',
      searchCallback,
    });
  });
  it('should create an action to set suggestCallback', () => {
    expect(configActions.setSuggestCallback(suggestCallback)).toEqual({
