...
import suggestionsParametersActions from '../../actions/suggestionsParametersActions';
...
describe('reducers/suggestionsParameters', () => {
  it('should return initial state when given empty input', () => {
    expect(
      suggestionsParameters.suggestionsParameters(
        <Store.SuggestionsParameters>undefined,
        <suggestionsParametersActions.SuggestionsParametersAction>{},
      ),
  ...
  it('should properly set api version', () => {
    ...
    expect(
      suggestionsParameters.suggestionsParameters(
        initialState,
        suggestionsParametersActions.setSuggestionsApiVersion(
          '2015-02-28-Preview',
        ),
      ),
  ...
  it('should properly set all searchParameters', () => {
    ...
    expect(
      suggestionsParameters.suggestionsParameters(
        initialState,
        suggestionsParametersActions.setSuggestionsParameters(testParameters),
      ),
  ...
  it('should properly update subset of suggestionsParameters', () => {
    ...
    expect(
      suggestionsParameters.suggestionsParameters(
        initialState,
        suggestionsParametersActions.updateSuggestionsParameters(
          testParameters,
        ),
      ),
    ).toEqual(expectedParams);
